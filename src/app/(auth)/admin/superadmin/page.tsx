...
const SuperAdminDashboard: React.FC = () => {
  ...
  useEffect(() => {
    // Redirect if user is not authenticated or not a super-admin
  ...
  // Show not authorized if user is authenticated but not a super-admin
  if (isAuthenticated && authUser?.role !== 'super-admin') {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#1a2332]">
        <div className="text-white">Access denied. Super admin privileges required.</div>
      </div>
    );
  }
